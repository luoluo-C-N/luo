...
try {
  ...
  const [{ default: site }, { default: lab }, { default: password }, { default: wallet }, { default: sync }, { default: album }] = await Promise.all([
    ...
    import('../modules/sync/manifest.js'),
    import('../modules/album/manifest.js'),
  ]);
