...
export const __exports__ = { saveCardSizes, applyCardSizes, startResize, addCustomSection, _oldAddCustomSection, setDark, setDarkToggle, applyGlassTuning, saveGlassTuning, syncGlassSliders, resetGlass, setAccent, shade, renderAccentPicker, renderThemePresets, applyTheme, setFontSize };
